...
| OQ-12 | **PDF route and 1.0 scope.** [10-pdf-css.md](10-pdf-css.md) recommends the print stylesheet (R3) for 1.0 and a build-time CSS PDF (Java engine, A4 default) for 1.1 after a one-week spike; decisions on the bundled TrueType family, PDF/UA by default, and default paper size are listed there | A only for 1.0 (recommended) / wait for B | 1.0 scope, 1.1 planning |
