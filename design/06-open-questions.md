...
| OQ-12 | **PDF route.** Settled for scope (2026-09-06): 1.0 takes the print stylesheet (R3) **and the single merged print document** (section 9a of [10-pdf-css.md](10-pdf-css.md)); the build-time CSS engine follows in 1.1 after a one-week spike. Still open: the bundled TrueType family, PDF/UA by default, A4 as default paper | See 10, Section 10 | 1.1 planning |
